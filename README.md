...
* 每节教程学习时间30分钟左右，由浅入深，循序渐进，从 完全不懂编程 到 逐渐掌握编程技能
...
* Asky教程打包下载（已更新第8节）：https://github.com/AskyEdu/Asky/raw/master/01_doc/Asky.zip
...
* Asky极简架构，目前是轻量级思路，不会加入过多的设计模式、动态切换组件等，将来有可能在合适的场景中加入一些需要的设计模式
